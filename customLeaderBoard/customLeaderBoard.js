...
showUserInfo() {
  ...
  let created = document.getElementById('createDate');
        ...
        <div class="container impar">
          <div class="container-content">
            <div class="profile-card">
              ...
              <p id="phone"><strong>Teléfono:</strong> 123456789</p>
              <p id="address"><strong>Dirección:</strong> Calle Falsa 123</p>
              <p id="country"><strong>País:</strong> España</p>
              <p id="company"><strong>Empresa:</strong> TurisCool</p>
              <p id="createDate"><strong>Fecha de alta:</strong> 01/01/2021</p>
              <p id="lastLogin"><strong>Último acceso:</strong> 01/01/2021</p>
            </div>
